...
const SHEET_HEADERS_26 = [
  ...
  'Email',              // Col 11
  'Role / Chức vụ',     // Col 12
  'Event Venue',        // Col 13 (Rạp Xiếc Phú Thọ)
  'Event Name',         // Col 14 (The SYNC Show — Norton Park)
...
function format26Columns(data = {}) {
  ...
  const row = [
    ...
    '•••• •••• ' + (data.cccdLast4 || data.cccd || ''),    // Col 9: CCCD / CMND
    ...
    'Rạp Xiếc Và Biểu Diễn Đa Năng Phú Thọ',             // Col 13: Event Venue
    'The SYNC Show — Norton Park',                         // Col 14: Event Name
